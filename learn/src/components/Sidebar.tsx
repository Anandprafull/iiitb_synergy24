...
const Sidebar = async ({ className }: SidebarProps) => {
  ...
  return (
    <div
      className={cn(
        "left-0 top-0 flex flex-col h-full border-r-2 px-4 md:fixed md:w-[225px] lg:w-[350px]",
        className
      )}
    >
      <Link href="/learn">
      ...
      <div className="flex flex-1 flex-col gap-y-2">
        ...
        <SidebarItem label="bot" href="/bot" iconSrc="/tbot.svg" />
        <SidebarItem label="Basics" href="/basics" iconSrc="/alpha.png" />
        <SidebarItem
          href="/leaderboard"
          label="leaderboard"
        ...
        <SidebarItem href="/feed" label="feed" iconSrc="/feed.svg" />
        <SidebarItem href="https://kannadamitra-note.netlify.app/" label="note" iconSrc="/note.svg" />
      </div>
