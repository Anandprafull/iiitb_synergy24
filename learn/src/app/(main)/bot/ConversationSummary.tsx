...
const ConversationSummary: React.FC<ConversationSummaryProps> = ({
  ...
  const generateSummary = async () => {
    ...
    try {
      const response = await fetch("https://savage-incantation-g4q5j45rq69xcjqp-5000.app.github.dev//generate-summary", {
        method: "POST",
        headers: {
  ...
  const downloadSummary = async () => {
    try {
      const response = await fetch("https://savage-incantation-g4q5j45rq69xcjqp-5000.app.github.dev//download-summary", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
